...
public class Airconditioner extends JPanel{
	...
	Airconditioner() {
		...
		int[] salePrice = { (int) (Math.random() * 1550000) + 200000, (int) (Math.random() * 1250000) + 200000,
				(int) (Math.random() * 2030000) + 300000, (int) (Math.random() * 219000) + 100000,
				(int) (Math.random() * 950000) + 200000, (int) (Math.random() * 1696600) + 200000 }; // 할인가격
