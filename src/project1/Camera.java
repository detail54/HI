...
public class Camera extends JPanel{
	...
	Camera() {
		...
		int[] salePrice = { (int) (Math.random() * 2150000) + 1000000, (int) (Math.random() * 579000) + 100000,
				(int) (Math.random() * 1799000) + 500000, (int) (Math.random() * 7400000) + 5000000,
				(int) (Math.random() * 2626000) + 500000, (int) (Math.random() * 2892500) + 500000 }; // 할인가격
