...
public class Computer extends JPanel{
	...
	Computer() {
		...
		int[] salePrice = { (int) (Math.random() * 2890000) + 200000, (int) (Math.random() * 499000) + 100000,
				(int) (Math.random() * 657500) + 200000, (int) (Math.random() * 874040) + 300000,
				(int) (Math.random() * 1390000) + 200000, (int) (Math.random() * 699000) + 200000 }; // 할인가격
